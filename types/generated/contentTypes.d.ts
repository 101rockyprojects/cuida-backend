...
export interface ApiAnimalAnimal extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::animal.animal', 'nombre'>;
...
export interface ApiNecesidadNecesidad extends Schema.CollectionType {
  ...
  attributes: {
    ...
    meta_dinero: Attribute.BigInteger &
      Attribute.Required &
      Attribute.SetMinMax<
        {
          min: '10000';
        ...
        string
      >;
    documento_soporte: Attribute.Media;
    estado: Attribute.Enumeration<['Activa', 'Satisfecha', 'Inactiva']>;
...
export interface ApiRefugioRefugio extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    necesidades: Attribute.Relation<
      'api::refugio.refugio',
      'oneToMany',
      'api::necesidad.necesidad'
    >;
...
export interface ApiRepresentanteRepresentante extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::representante.representante': ApiRepresentanteRepresentante;
    }
  }
}
